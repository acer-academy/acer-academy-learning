      ...
      <div className="fixed inset-0 z-10 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none focus:outline-none">
        ...
        <div className="relative bg-white p-5 rounded-lg shadow-md h-42 w-96">
          <div className="flex items-start justify-between">
            <div className=" w-0 flex-1 pt-0.5">
              ...
              <p className="mt-3 text-sm text-gray-500">
                Are you sure you want to redeem this reward? This action cannot
                be undone.
              </p>
            </div>
          </div>
          <div className="mt-4 flex justify-end">
            ...
            <button
              className="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-md hover:bg-green-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-green-500"
              onClick={() => {
