...
interface CreditBundleDeleteModalProps {
  setIsModalOpen: (isModalOpen: boolean) => void;
  deleteCreditBundle: () => void;
}

export const CreditBundleDeleteModal: React.FC<
  CreditBundleDeleteModalProps
> = ({ setIsModalOpen, deleteCreditBundle }) => {
  return (
          ...
          <div className="flex items-start justify-between">
            <div className=" w-0 flex-1 pt-0.5">
              ...
              <p className="mt-3 text-sm text-gray-500">
                Are you sure you want to delete this credit bundle? This action
                cannot be undone.
              </p>
            </div>
          </div>
