            ...
            <div className="w-full mb-5">
              ...
              <div className="relative rounded-md shadow-sm">
                <textarea
                  name="body"
                  id="body"
                  className="block w-full rounded-md break-normal align-left border-0 py-1.5 h-32 text-gray-900 ring-1 ring-inset ring-gray-300 text-gray-900 focus:ring-adminGreen-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 whitespace-normal"
