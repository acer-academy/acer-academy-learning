                  ...
                  {attendances.filter(
                    ...
                    <td className="flex items-center justify-center px-20 py-2">
                      <button
                        ...
                        className="flex w-full justify-center rounded-md bg-teacher-secondary-900 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-teacher-primary-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teacher-secondary-600"
                      >
                        Mark
                      </button>
                    </td>
